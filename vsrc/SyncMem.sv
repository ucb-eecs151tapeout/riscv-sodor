...
//         end
//       end
//       assign  hr_data[i*8 +: 8] = mem[reghr_addr[13:0] + i];
//       assign  dataInstr_0_data[i*8 +: 8] = mem[regdataInstr_0_addr[13:0] + i];
//       assign  dataInstr_1_data[i*8 +: 8] = mem[regdataInstr_1_addr[13:0] + i];
//     end
//   endgenerate
